...
summary_poisson %>% 
  ...
  write_csv(.,"paper/nlma02_poisson outcomes x economic shocks in urban.csv")
...
write_csv(marginal_predictions,paste0("paper/nlma02_marginal predictions from poisson for urban.csv"))
...
#   write_csv(.,"paper/nlma02_prediction for unique months and year for urban.csv")
# 
# 
