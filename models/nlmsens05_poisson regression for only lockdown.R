...
glm_stunting <- svyglm(c_stunting ~ ns(c_age,df=4) + e2_p1_d + e2_p2_d + e2_p3_d + e2_p4_d + e2_p5_d + 
                         m_caste + m_rural + m_wealthq + m_religion + m_education + m_alcohol + m_smoking + factor(v024_nfhs5),design = analytic_survey,
                       family = poisson())

glm_underweight <- svyglm(c_underweight ~ ns(c_age,df=4) + e2_p1_d + e2_p2_d + e2_p3_d + e2_p4_d + e2_p5_d + 
                            m_caste + m_rural + m_wealthq + m_religion + m_education + m_alcohol + m_smoking + factor(v024_nfhs5),design = analytic_survey,
                          family = poisson())

glm_wasting <- svyglm(c_wasting ~ ns(c_age,df=4) + e2_p1_d + e2_p2_d + e2_p3_d + e2_p4_d + e2_p5_d + 
                        m_caste + m_rural + m_wealthq + m_religion + m_education + m_alcohol + m_smoking + factor(v024_nfhs5),design = analytic_survey,
                      family = poisson())
...
summary_poisson %>% 
  ...
  write_csv(.,"paper/table_poisson outcomes x lockdown only.csv")


# Marginal standardization -------------

exposures <- c("e2_p1_d","e2_p2_d","e2_p3_d","e2_p4_d","e2_p5_d")
...
write_csv(marginal_predictions,paste0("paper/table_marginal predictions from poisson for lockdown only.csv"))
