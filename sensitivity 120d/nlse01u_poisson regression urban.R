...
saveRDS(save_svyglm(glm_stunting) ,paste0(path_lockdown_folder,"/working/nlse/nlse01u_glm_stunting.RDS"))
saveRDS(save_svyglm(glm_underweight),paste0(path_lockdown_folder,"/working/nlse/nlse01u_glm_underweight.RDS"))
saveRDS(save_svyglm(glm_wasting),paste0(path_lockdown_folder,"/working/nlse/nlse01u_glm_wasting.RDS"))
# Stunting -----------
...
summary_poisson %>% 
  ...
  write_csv(.,"sensitivity 120d/nlse01u_summary poisson regression urban.csv")
