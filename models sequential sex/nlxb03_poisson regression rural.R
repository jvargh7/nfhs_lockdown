...
saveRDS(save_svyglm(glm_stunting) ,paste0(path_lockdown_folder,"/working/nlxb/nlxb03_glm_stunting.RDS"))
saveRDS(save_svyglm(glm_underweight),paste0(path_lockdown_folder,"/working/nlxb/nlxb03_glm_underweight.RDS"))
saveRDS(save_svyglm(glm_wasting),paste0(path_lockdown_folder,"/working/nlxb/nlxb03_glm_wasting.RDS"))
# Stunting -----------
...
summary_poisson %>% 
  ...
  write_csv(.,"models sequential sex/nlxb03_poisson outcomes x economic shocks in rural.csv")
...
write_csv(.,paste0("models sequential sex/nlxb03_marginal predictions from poisson for rural.csv"))
...
# 
#   write_csv(.,"models sequential sex/nlxb03_prediction for unique months and year for rural.csv")