...
summary_poisson %>% 
  ...
  write_csv(.,"sensitivity/sens03_poisson outcomes x economic shocks in rural.csv")
...
write_csv(marginal_predictions,paste0("sensitivity/sens03_marginal predictions from poisson for rural.csv"))
