...
nls5_outcomes <- left_join(read_csv("sensitivity nfhs5/nls501u_summary poisson regression urban.csv") %>% 
                             rename_at(vars(Stunting,Underweight,Wasting),~paste0("Urban_",.)),
                           read_csv("sensitivity nfhs5/nls501r_summary poisson regression rural.csv") %>% 
...
write_csv(nls5_outcomes,("paper/nls5_coefficients.csv"))
