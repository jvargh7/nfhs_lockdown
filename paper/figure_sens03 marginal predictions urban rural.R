...
marginal_rural <- read_csv(paste0("sensitivity/sens03_marginal predictions from poisson for rural.csv"))
marginal_urban <- read_csv(paste0("sensitivity/sens03_marginal predictions from poisson for urban.csv"))
...
ggarrange(figA,
  ...
  ggsave(.,filename = paste0(path_lockdown_folder,"/figures/figure_sens03 marginal predictions urban rural.png"),width = 12,height = 10)
