...
write_csv(summary_e_interaction_region,("paper/summary boys urban rural counts by exposure.csv"))


nlxb_outcomes <- left_join(read_csv("sensitivity boys/nlxb01u_summary poisson boys urban.csv") %>% 
                             rename_at(vars(Stunting,Underweight,Wasting),~paste0("Urban_",.)),
                           read_csv("sensitivity boys/nlxb01r_summary poisson boys rural.csv") %>% 
...
write_csv(nlxb_outcomes,("paper/nlxb_coefficients.csv"))
