glm_stunting <- readRDS(paste0(path_lockdown_folder,"/working/nlma/nlma01r_glm_stunting.RDS"))
glm_underweight <- readRDS(paste0(path_lockdown_folder,"/working/nlma/nlma01r_glm_underweight.RDS"))
glm_wasting <- readRDS(paste0(path_lockdown_folder,"/working/nlma/nlma01r_glm_wasting.RDS"))
...
write_csv(rr_summary,paste0("main analysis/nlma04r_relative risk of consecutive rural.csv"))
