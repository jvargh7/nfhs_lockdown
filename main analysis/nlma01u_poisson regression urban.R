...
saveRDS(save_svyglm(glm_stunting) ,paste0(path_lockdown_folder,"/working/nlma/nlma01u_glm_stunting.RDS"))
saveRDS(save_svyglm(glm_underweight),paste0(path_lockdown_folder,"/working/nlma/nlma01u_glm_underweight.RDS"))
saveRDS(save_svyglm(glm_wasting),paste0(path_lockdown_folder,"/working/nlma/nlma01u_glm_wasting.RDS"))
...
summary_poisson %>% 
  ...
  write_csv(.,"main analysis/nlma01u_summary poisson regression urban.csv")
