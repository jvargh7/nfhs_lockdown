...
summary_poisson %>% 
  ...
  write_csv(.,"models with sequential interactions/nlsb02_poisson outcomes x economic shocks in urban.csv")
...
write_csv(marginal_predictions,paste0("models with sequential interactions/nlsb02_marginal predictions from poisson for urban.csv"))
...
bind_cols(overlaps,pred_overlaps) %>% 
  write_csv(.,"models with sequential interactions/nlsb02_prediction for unique months and year for urban.csv")
