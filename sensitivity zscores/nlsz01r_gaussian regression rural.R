...
saveRDS(save_svyglm(glm_haz) ,paste0(path_lockdown_folder,"/working/nlsz/nlsz01r_glm_haz.RDS"))
saveRDS(save_svyglm(glm_waz),paste0(path_lockdown_folder,"/working/nlsz/nlsz01r_glm_waz.RDS"))
saveRDS(save_svyglm(glm_whz),paste0(path_lockdown_folder,"/working/nlsz/nlsz01r_glm_whz.RDS"))
...
summary_gaussian %>% 
  ...
  write_csv(.,"sensitivity zscores/nlsz01r_summary gaussian regression rural.csv")