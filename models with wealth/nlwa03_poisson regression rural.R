...
summary_poisson %>% 
  ...
  write_csv(.,"models with wealth/nlwa03_poisson outcomes x economic shocks in rural.csv")
...
write_csv(marginal_predictions,paste0("models with wealth/nlwa03_marginal predictions from poisson for rural.csv"))
...
#   write_csv(.,"models with wealth/nlwa03_prediction for unique months and year for rural.csv")
# 
