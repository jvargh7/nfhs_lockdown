...
# G = 7 to 12
eg2 = paste0("~ p2_cumulative + p3_cumulative + factor(nfhs5_state) + pc1 + factor(c_measurementmonth) ",c_covariates,m_covariates,hh_covariates)

eg3 = paste0("~ p3_cumulative + p4_cumulative + factor(nfhs5_state) + pc1 + factor(c_measurementmonth) ",c_covariates,m_covariates,hh_covariates)

eg4 = paste0("~ p4_cumulative + p5_cumulative + factor(nfhs5_state) + pc1 + factor(c_measurementmonth) ",c_covariates,m_covariates,hh_covariates)

eg5 = paste0("~ p5_cumulative + p6_cumulative + factor(nfhs5_state) + pc1 + factor(c_measurementmonth) ",c_covariates,m_covariates,hh_covariates)
