...
glm_stunting <- svyglm(as_formula(paste0("c_stunting ~ e1_p1_d + e1_p2_d + e1_p3_d + e1_p4_d + e1_p5_d +
                            e2_p1_d + e2_p2_d + e2_p3_d + e2_p4_d + e2_p5_d",total_covariates)),design = analytic_survey,
                       family = quasipoisson())
...
summary_poisson %>% 
  ...
  write_csv(.,"models/nlwb01_poisson outcomes x economic shocks.csv")
...
write_csv(marginal_predictions,paste0("models/nlwb01_marginal predictions from poisson for outcomes.csv"))
