...
saveRDS(save_svyglm(glm_stunting) ,paste0(path_lockdown_folder,"/working/nlsa/nlsa01r_glm_stunting.RDS"))
saveRDS(save_svyglm(glm_underweight),paste0(path_lockdown_folder,"/working/nlsa/nlsa01r_glm_underweight.RDS"))
saveRDS(save_svyglm(glm_wasting),paste0(path_lockdown_folder,"/working/nlsa/nlsa01r_glm_wasting.RDS"))
...
summary_poisson %>% 
  ...
  write_csv(.,"sensitivity additive/nlsa01r_summary poisson regression rural.csv")
