...
summary_poisson %>% 
  ...
  write_csv(.,"models/nlwb02_poisson outcomes x economic shocks in urban.csv")
...
write_csv(marginal_predictions,paste0("models/nlwb02_marginal predictions from poisson for urban.csv"))
